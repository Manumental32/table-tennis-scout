import { CalendarDays, Home, Swords, Users } from 'lucide-react'
...
export default function BottomNav({ currentView, onNavigate }) {
  return (
    <nav
      ...
      className="border-t border-slate-800 bg-slate-900 pb-[env(safe-area-inset-bottom)]"
    >
          ...
          return (
            <li key={item.id}>
              <button
                ...
                className={`flex min-h-16 w-full flex-col items-center justify-center gap-1 px-1 text-xs font-medium ${
